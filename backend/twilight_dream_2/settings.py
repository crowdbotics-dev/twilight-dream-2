"""
Django settings for twilight_dream_2 project.
...
ROOT_URLCONF = 'twilight_dream_2.urls'
...
WSGI_APPLICATION = 'twilight_dream_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "twilight_dream_2 API",
    "DESCRIPTION": "API documentation for twilight_dream_2 App",
    "VERSION": "v1",
}
